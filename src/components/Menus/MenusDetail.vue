        ...
        <div class="flex justify-between p-4 space-y-2 mb-2">
          ...
          >
            <input
              id="title"
              v-model="menu.title"
              class="mt-1 px-3 py-2 bg-zinc-500 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-xl focus:ring-1"
              type="text"
            >
          </div>
          <div class="flex">
